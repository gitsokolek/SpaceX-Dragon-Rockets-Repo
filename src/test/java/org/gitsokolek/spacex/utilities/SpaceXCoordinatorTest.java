...
class SpaceXCoordinatorTest
{
	...
	void cannotAssignToEndedMission()
	{
		...
		Dragon d = coord.createDragon("Dx");
		assertThrows(IllegalStateException.class, () -> coord.assignDragon(m.getId(), d.getId()));
	}
	...
	void assignToMissingMissionThrows()
	{
		...
		assertThrows(IllegalArgumentException.class, () -> coord.assignDragon(missing, d.getId()));
	}
	...
	void assignMissingDragonThrows() {
		...
		assertThrows(IllegalArgumentException.class, () -> coord.assignDragon(m.getId(), missing));
	}
	...
	@Test void endMissionIsIdempotent() {
		InMemoryMissionRepository mRepo = new InMemoryMissionRepository();
		InMemoryDragonRepository dRepo = new InMemoryDragonRepository();
		SpaceXCoordinator coord = new SpaceXCoordinator(mRepo, dRepo);
	...
	@Test void allOnGroundYieldsPending() {
		InMemoryMissionRepository mRepo = new InMemoryMissionRepository();
		InMemoryDragonRepository dRepo = new InMemoryDragonRepository();
		SpaceXCoordinator coord = new SpaceXCoordinator(mRepo, dRepo);
	...
	@Test void mixedInSpaceAndInRepairYieldsPending() {
		InMemoryMissionRepository mRepo = new InMemoryMissionRepository();
		InMemoryDragonRepository dRepo = new InMemoryDragonRepository();
		SpaceXCoordinator coord = new SpaceXCoordinator(mRepo, dRepo);
	...
	@Test void allInSpaceYieldsInProgress() {
		InMemoryMissionRepository mRepo = new InMemoryMissionRepository();
		InMemoryDragonRepository dRepo = new InMemoryDragonRepository();
		SpaceXCoordinator coord = new SpaceXCoordinator(mRepo, dRepo);
	...
	@Test void setDragonStatusWithoutMissionIsSafe() {
		InMemoryMissionRepository mRepo = new InMemoryMissionRepository();
		InMemoryDragonRepository dRepo = new InMemoryDragonRepository();
		SpaceXCoordinator coord = new SpaceXCoordinator(mRepo, dRepo);
	...
	@Test void deleteDragonInRepairRecomputesMission() {
		InMemoryMissionRepository mRepo = new InMemoryMissionRepository();
		InMemoryDragonRepository dRepo = new InMemoryDragonRepository();
		SpaceXCoordinator coord = new SpaceXCoordinator(mRepo, dRepo);
